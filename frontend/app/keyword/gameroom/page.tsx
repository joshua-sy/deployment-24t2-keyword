  ...
  return (
    <>
      <div className="\backgroundDiv bg-robot bg-cover h-screen bg-center-left-px">
        <div className="contentContainer text-center w-full max-w-md mx-auto backdrop-blur-sm space-y-4 sm:space-y-0">
          <h1 className='text-white text-xl sm:text-2xl'>Welcome to the Game Room</h1>
          <p className='text-white text-xl sm:text-2xl'>CODE: {roomCode}</p>
          <RedButton
            label='COPY CODE'
            onClick={handleCopy}
          />
