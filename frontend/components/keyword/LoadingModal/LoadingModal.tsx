  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-75 z-50">
      <div className="flex flex-col items-center bg-white px-36 py-36">
        ...
        <svg aria-hidden="true" className="inline w-24 h-24 text-gray-200 animate-spin dark:text-gray-600 fill-figma-red" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
