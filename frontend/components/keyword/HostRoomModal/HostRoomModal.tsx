    ...
    <React.Fragment>
      ...
      >
        ...
        <Button 
          ...
          <Button onClick={handleClickOpen} type="submit" style = {{right: '4px', color: 'white', backgroundColor: "red", justifyContent: 'center', position: 'relative', bottom: 0, width: '100%'}}>HOST</Button>
        </DialogActions>
      </Dialog>
    </React.Fragment>
  );
